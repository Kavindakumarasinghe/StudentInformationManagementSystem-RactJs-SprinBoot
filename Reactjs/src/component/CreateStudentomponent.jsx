...
class CreateStudentomponent extends Component {
            ...
            <div className = "container">
               <div className="row"></div>
                <div className="card col-md-6 offset-md-3 offset-md-3 mt-5">
                    <h3 className="text-center" style={{fontSize:"22pt",color:"#000080"}}>Add Student</h3>
                        ...
                        <form > 
                            ...
                            <button style={{fontSize:"15pt", backgroundColor:"#00FF00",color:"#006400",fontWeight:"bold"}}className="btn btn-success " onClick={this.saveStudent}>Save</button>
...
export default CreateStudentomponent;