                            ...
                            <tbody style={{fontSize:"14pt"}}>
                                {this.state.students.map(
                                    ...
                                    <tr key={student.id} >
                                        ...
                                        <td>
                                            <button onClick={() => this.editStudent(student.id)} style={{fontSize:"15pt",backgroundColor:"#00FF00",color:"#006400",fontWeight:"bold"}} className="btn btn-info">Update</button>
                                            <button  style= {{marginLeft:"10px",backgroundColor:"#FF0000",fontSize:"15pt",fontWeight:"bold" } }onClick={() => this.deleteStudent(student.id)} className="btn btn-danger">Delete</button>
                                        </td>
